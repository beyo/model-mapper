...
describe('Test Evolution', function () {
  ...
  beforeEach(function * () {
    var evolutionConfig = path.join(process.cwd(), EVOLUTION_CONFIG_FILE);
  ...
  it('should apply all patches', function * () {
    var mapper = yield Mapper.define('EvoMapper1');
  ...
  it('should apply and rollback', function * () {
    var mapper = yield Mapper.define('EvoMapper2');
  ...
  it('should fail with invalid version', function * () {
    var mapper = yield Mapper.define('EvoMapper3');
    var versions = [
